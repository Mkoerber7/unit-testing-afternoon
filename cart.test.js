...
describe('Cart Methods:', function() {
    ...
    test('addToCart should add a car to cart array', () => {
    ...
    test('addTocCart should increase the total property', () => {
        cart.addToCart( cars[0] );
    ...
    test('checkout should empty the cart array and total should equal 0', () => {
        cart.addToCart( cars[0] );
        cart.addToCart( cars[1] );
        cart.addToCart( cars[2] );
